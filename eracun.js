...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    if (napaka1 || napaka2){ 
      sporociloNapaka = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
    }
    else {
      sporociloNapaka = "Stranka je bila uspešno registrirana.";
    }
...
streznik.get('/prijava', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: sporociloNapaka, seznamStrank: stranke, seznamRacunov: racuni});  
      }) 
    });
})
